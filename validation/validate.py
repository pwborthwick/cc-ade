...
class validate(object):
    ...
    def __init__(self, ade, testdata='hf'):
        
        current_directory = os.path.dirname(__file__) + '/'
        
        self.amplitude_file = current_directory + testdata + '.npz'
        self.reference_file = current_directory + 'reference.txt'
        self.has_q = testdata in ['c']

        self.occ = {'hf':10, 'c':6}[testdata]
        self.ade = ade
        self.amplitudes()
        self.load()
